...
export default function WhyChooseUs() {
  return (
    ...
    >
      ...
      <div className="relative container mx-auto flex justify-end px-6 lg:px-20 py-8">
        {/* Right Content */}
        <div className="w-full lg:w-1/2 text-white">
          {/* Heading */}
          <div className="mb-4">
            <h4 className="text-sm md:text-base font-medium">Why Choose Us</h4>
            <h2 className="text-2xl md:text-3xl lg:text-xl font-bold mt-2 leading-snug">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {/* Card 1 */}
            <div className="bg-[#0B0E40]/60 p-4 h-[220px] flex flex-col items-center text-center shadow-md">
